...
- Пользователь задаёт блоки по десктопной версии; мобильную компоновку воспроизводить по указанной ссылке на шаблон без добавления новых смысловых элементов.
