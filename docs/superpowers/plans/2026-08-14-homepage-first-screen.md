...
## Task 3: Блок «Почему выбирают ЭМКОМ?»

- Добавить после услуг заголовок, вводный текст и пять утверждённых фичеров.
- Добавить к каждому фичеру серый круг-плейсхолдер вместо пиктограммы; не добавлять кнопку или надзаголовок.
- После фичеров добавить широкий серый плейсхолдер изображения.
- Адаптировать двухколоночную композицию в одну колонку на мобильном экране.
